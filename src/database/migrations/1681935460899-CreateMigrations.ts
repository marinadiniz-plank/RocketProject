...
export class CreateMigrations1681935460899 implements MigrationInterface {
    name = 'CreateMigrations1681935460899'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "crew" ("name" character varying NOT NULL, "id" SERIAL NOT NULL, CONSTRAINT "PK_cc72b429996b3476dbaac59f1c2" PRIMARY KEY ("id"))`);
