...
export class CreateMigrations1685369775924 implements MigrationInterface {
    name = 'CreateMigrations1685369775924'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "crewman" ("name" character varying NOT NULL, "id" SERIAL NOT NULL, "patent" character varying NOT NULL, CONSTRAINT "PK_4fb6d9687691fd6b62b98a62955" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "launch" DROP COLUMN "launchCode"`);
        await queryRunner.query(`ALTER TABLE "launch" ADD "launchCode" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "launch" DROP COLUMN "date"`);
        await queryRunner.query(`ALTER TABLE "launch" ADD "date" TIMESTAMP NOT NULL DEFAULT now()`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "launch" DROP COLUMN "date"`);
        await queryRunner.query(`ALTER TABLE "launch" ADD "date" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "launch" DROP COLUMN "launchCode"`);
        await queryRunner.query(`ALTER TABLE "launch" ADD "launchCode" character varying NOT NULL`);
